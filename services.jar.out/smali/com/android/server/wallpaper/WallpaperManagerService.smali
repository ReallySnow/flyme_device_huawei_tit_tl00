...
.method private generateCrop(Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;)V
    ...
    .line 339
    .local v7, "cropHint":Landroid/graphics/Rect;
    ...
    .line 343
    :cond_0
    const-string/jumbo v30, "WallpaperManagerService"

    const-string/jumbo v31, "Invalid wallpaper data"
    ...
    const-string/jumbo v31, "Unable to apply new wallpaper"
    ...
    invoke-virtual/range {v30 .. v30}, Ljava/io/File;->getAbsoluteFile()Ljava/io/File;

    move-result-object v30

    invoke-static/range {v30 .. v30}, Landroid/os/SELinux;->restorecon(Ljava/io/File;)Z
    ...
    .line 347
    .local v21, "needCrop":Z
    const/16 v22, 0x0

    .line 350
    .local v22, "needScale":Z
    ...
    .line 415
    .local v15, "f":Ljava/io/FileOutputStream;
    const/4 v5, 0x0
    ...
    .line 417
    invoke-static/range {v30 .. v31}, Landroid/graphics/BitmapRegionDecoder;->newInstance(Ljava/lang/String;Z)Landroid/graphics/BitmapRegionDecoder;
    ...
    .line 426
    .local v4, "actualScale":I
    const/16 v28, 0x1

    .line 427
    .local v28, "scale":I
    :goto_3
    mul-int/lit8 v30, v28, 0x2
    ...
    invoke-static/range {v30 .. v31}, Landroid/os/FileUtils;->copyFile(Ljava/io/File;Ljava/io/File;)Z
    ...
    .line 434
    .local v14, "estimateCrop":Landroid/graphics/Rect;
    move-object/from16 v0, v25
    ...
    invoke-virtual {v9, v7, v0}, Landroid/graphics/BitmapRegionDecoder;->decodeRegion(Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    const-string/jumbo v31, "Could not decode new wallpaper"
    ...
    .line 492
    .local v19, "finalCrop":Landroid/graphics/Bitmap;
    invoke-virtual/range {v19 .. v19}, Landroid/graphics/Bitmap;->getByteCount()I

    move-result v30

    const/high16 v31, 0x6400000
    ...
    .line 494
    const-string/jumbo v31, "Too large bitmap, limit=104857600"
    ...
    .end local v9    # "decoder":Landroid/graphics/BitmapRegionDecoder;
    .end local v10    # "destHeight":I
    .end local v11    # "destWidth":I
    .end local v14    # "estimateCrop":Landroid/graphics/Rect;
    .end local v19    # "finalCrop":Landroid/graphics/Bitmap;
    .end local v20    # "hRatio":F
    ...
    .restart local v4    # "actualScale":I
    .restart local v5    # "bos":Ljava/io/BufferedOutputStream;
    .restart local v8    # "cropped":Landroid/graphics/Bitmap;
    .restart local v9    # "decoder":Landroid/graphics/BitmapRegionDecoder;
    .restart local v10    # "destHeight":I
    .restart local v11    # "destWidth":I
    .restart local v14    # "estimateCrop":Landroid/graphics/Rect;
    .restart local v15    # "f":Ljava/io/FileOutputStream;
    .restart local v19    # "finalCrop":Landroid/graphics/Bitmap;
    .restart local v20    # "hRatio":F
    .restart local v26    # "safeHeight":I
    .restart local v27    # "safeWidth":I
    .restart local v28    # "scale":I
    :cond_15
    :try_start_3
